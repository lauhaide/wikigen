...
require('onmt.modules.WikiDataEncoder')
require('onmt.modules.HierarchicalDecoder')
require('onmt.modules.GuidedAlnGenerator')
require('onmt.modules.ReinforceDecoder')
require('onmt.modules.ReinforceCriterion')
require('onmt.modules.ReinforceSampler')
require('onmt.modules.ReinforceGenerator')
require('onmt.modules.ReinforceDecoderBlock')
